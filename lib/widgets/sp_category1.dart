...
class SpecialCategory1 extends StatefulWidget {
  const SpecialCategory1({super.key, required this.catID});
  final String catID;

  @override
  State<SpecialCategory1> createState() => _SpecialCategory1State();
}

class _SpecialCategory1State extends State<SpecialCategory1> with AutomaticKeepAliveClientMixin {
