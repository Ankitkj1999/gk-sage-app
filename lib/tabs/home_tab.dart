          ...
          children: [
            ...
            Column(
              children: [
                ...
                sb.specialCategory.enabled ?? false ? SpecialCategory1(catID: sb.specialCategory.id1.toString()) : const SizedBox.shrink(),
                const SizedBox(height: 30),
                sb.specialCategory.enabled ?? false ? SpecialCategory2(catID: sb.specialCategory.id2.toString()) : const SizedBox.shrink(),
                sb.selfChallengeModeEnabled ? const _SelfChallengeContainer() : const SizedBox.shrink(),
                ab.isRewardedEnabled ? const RewardedAdContainer() : const SizedBox.shrink(),
              ],
            ),
          ],
        ),
