      ...
      body: pointsHistory.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                final String rawtitle = pointsHistory[index]
                    .substring(0, pointsHistory[index].indexOf(' at '));
                final String title =
                    rawtitle.replaceAll(RegExp(r'[^\w\s]+|\d+'), '');
                ...
                final String subtitle = pointsHistory[index]
                    ...
                    .replaceAll('at ', '')
                    .trim();
                final String date = DateFormat('MM/dd/yyyy hh:mm a')
